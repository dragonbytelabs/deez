...
import { AdminDZFormsPreview } from "./admin-dzforms-preview";
...
export const Routes = () => {
	return (
		<Router root={Layout}>
			...
			/>
			<Route
				path="/_/admin/plugins/dzforms/preview/:id"
				component={() => (<ProtectedRoute><AdminDZFormsPreview/></ProtectedRoute>)}
			/>
			<Route
