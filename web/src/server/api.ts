...
const registerFunc = async (email: string, password: string, confirmPassword: string) => {
...
type ApiRoutes = {
    ...
    register: (email: string, password: string, confirmPassword: string) => Promise<Response>;
